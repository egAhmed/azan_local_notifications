...
/// implement.
abstract class AzanLocalNotificationsPlatformInterface extends PlatformInterface {
  /// Constructs an instance of [FlutterLocalNotificationsPlatform].
  AzanLocalNotificationsPlatformInterface() : super(token: _token);

  static late AzanLocalNotificationsPlatformInterface _instance;

  static final Object _token = Object();

  /// The default instance of [FlutterLocalNotificationsPlatform] to use.
  static AzanLocalNotificationsPlatformInterface get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [FlutterLocalNotificationsPlatform] when they register
  /// themselves.
  static set instance(AzanLocalNotificationsPlatformInterface instance) {

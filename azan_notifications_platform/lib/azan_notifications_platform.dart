...
/// implement.
abstract class AzanLocalNotificationsPlatform extends PlatformInterface {
  /// Constructs an instance of [FlutterLocalNotificationsPlatform].
  AzanLocalNotificationsPlatform() : super(token: _token);

  static late AzanLocalNotificationsPlatform _instance;

  static final Object _token = Object();

  /// The default instance of [FlutterLocalNotificationsPlatform] to use.
  static AzanLocalNotificationsPlatform get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [FlutterLocalNotificationsPlatform] when they register
  /// themselves.
  static set instance(AzanLocalNotificationsPlatform instance) {

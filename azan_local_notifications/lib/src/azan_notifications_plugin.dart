...
class AzanNotificationsPlugin {
  /// Factory for create an instance of [AzanNotificationsPlugin].
  factory AzanNotificationsPlugin() => _instance;

  AzanNotificationsPlugin._() {
    if (kIsWeb) {
      return;
    }
  ...
  static final AzanNotificationsPlugin _instance =
      AzanNotificationsPlugin._();
